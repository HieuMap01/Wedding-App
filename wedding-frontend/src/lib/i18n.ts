...
export const translations = {
  vi: {
    ...
    timelineTitle: "💕 Hành trình yêu thương",
    ...
    giftTitle: "Mừng cưới",
    giftDesc:
      "Nếu bạn muốn gửi quà mừng cưới tới chúng mình, bạn có thể chuyển khoản qua thông tin dưới đây.",
    giftBank: "Ngân hàng",
  ...
  en: {
    ...
    timelineTitle: "💕 Our Love Journey",
    ...
    giftDesc:
      "If you would like to send a wedding gift, you can use the bank information below.",
    giftBank: "Bank",
